    ...
    def get_info_from_track(self, track: dict, include_analysis=True) -> dict[str, str]:
        ...
        if include_analysis:
            try:
                ...
                info['analysis_time_signature_confidence'] = ''
                info['analysis_key'] = ''
                info['analysis_key_confidence'] = ''
                info['analysis_mode'] = ''
            ...
            try:
                ...
                info['features_instrumentalness'] = ''
                info['features_liveness'] = ''
                info['features_loudness'] = ''
                info['features_valence'] = ''
